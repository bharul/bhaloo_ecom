    <div class="main-menu-bar">
      <div class=" w-100 d-flex justify-content-between align-items-center px-3 h-10" style="background-color: rgba(255, 255, 255, 0.3);">
        <h2 class="col-md-2">LoGo</h2>
        <form class="d-flex my-2 col-md-3">
          <button class="p-2" style="border:none; border-radius: 50px 0 0 50px"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
              <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
            </svg></button>
          <input class="w-100" type="search" style="border:none; border-radius:0 50px 50px 0; outline:none; caret-color:rgba(100, 102, 102, 0.8);" placeholder="Search" aria-label="Search">
        </form>
        <div class=" col-md-6 mt-3 main-menu" style="padding-left: 40px;">
          <ul class="d-flex list justify-content-around">
        ...
        <div class="d-flex align-items-center col-md-2">
          <img src="images/avatar_1.webp" alt="Default Avatar" class="circular-image" style="max-width: 5em; border-radius: 50%; height:30px; padding-right: 5px;">
          <h6 class="">Login</h6>
        </div>
    </div>
    ...
    <div class="side-menu-bar position-fixed vh-100">
      ...
      <div class="col-12 text-center" id="make_sticky" style="position:sticky; top: 1px; background-color: #fff">
